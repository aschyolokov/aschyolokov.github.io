...
$form['callbackForm'] = array(
  ...
  'cfg' => array(
    ...
    'title' => 'Заказ услуги (Выкуп помещений)',
    'ajax' => true,
    'validate' => true,
    'from_email' => '',
...
$form['feedbackFormStart'] = array(
  'fields' => array(
    'nameFeedbackStart' => array(
      'title' => 'Имя',
      'validate' => array(
        'required' => true,
        'minlength' => '3',
...
$form['feedbackFormGetList'] = array(
  'fields' => array(
    'nameFeedbackGetList' => array(
      'title' => 'Имя',
      'validate' => array(
        'required' => true,
        'minlength' => '3',
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Сообщение с сайта Содружество Земельных Юристов (Выкуп помещений)',
    'title' => 'Получение списка с причинами отказа (Выкуп помещений)',
    'ajax' => true,
    'validate' => true,
    'from_email' => '',
    'from_name' => 'Содружество Земельных Юристов',
    'to_email' => $toMailMail . ', ' . $toEmail2,
    'to_name' => '',
    'geoip' => true,
    'referer' => true,
    'type' => 'html',
...
$form['feedbackForm'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Сообщение с сайта Содружество Земельных Юристов (Выкуп помещений)',
    'title' => 'Форма обратной связи (Выкуп помещений)',
    'ajax' => true,
    'validate' => true,
    'from_email' => '',
    'from_name' => 'Содружество Земельных Юристов',
...
$form['orderService'] = array(
  'fields' => array(
    'typeOrderService' => array(
      'title' => 'Заказанная услуга'
    ),
    'nameOrderService' => array(
      'title' => 'Имя',
      'validate' => array(
        'required' => true,
        'minlength' => '3',
