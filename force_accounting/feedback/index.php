...
$form['feedback-form'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Сообщение с сайта Финансовый консалтинг Force Accounting',
    'title' => 'Форма обратной связи с сайта',
    'ajax' => true,
    'validate' => true,
    'from_email' => '',
    'from_name' => 'Force Accounting',
    'to_email' => 'info@forceaccounting.ru',
    'to_name' => '',
    'geoip' => true,
    'referer' => true,
    'type' => 'html',
...
$form['feedback-form-phone'] = array(
  'fields' => array(
    'phonefeedbacksingle' => array(
      'title' => 'Телефон',
      'validate' => array(
        'required' => true,
        'preg' => "/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/im",
