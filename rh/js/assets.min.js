...
"undefined"!=typeof c)return c;return d}}),window.isset=function(a){if("object"==typeof a&&"undefined"==a)return!1;if(0===arguments.length)return!1;for(var b=arguments[0],c=0;c<arguments.length;c++){if("undefined"==typeof b||null===b)return!1;b=b[arguments[c+1]]}return!0};var mcf=myconf();mcf.done(function(a){function b(b){var c=$(b.form).find(".e-btn_feedback"),d=(c.clone(),c.val(),a[b.act].cfg);$.ajax({type:"POST",url:"feedback/",cache:!1,dataType:"json",data:"act="+b.act+"&"+b.data,beforeSend:function(){$(c).prop("disabled",!0),$(c).addClass("is-loading")},success:function(a){$("input[name], textarea[name]").blur(function(){$(this).next(".error-message").remove()}),$(".error-message").remove(),isset(d.notify)&&!/none/i.test(d.notify)&&(/textbox/i.test(d.notify)&&isset(a.errors)&&$.each(a.errors,function(a,b){$("input[name="+a+"], textarea[name="+a+"]").after('<label class="error-message">'+b+"</label>")}),/color/i.test(d.notify)&&($(b.form).find("input[type=text]:visible, input[type=tel]:visible, textarea:visible").blur(function(){$(this).removeClass("error")}),$(b.form).find("input[type=text]:visible, input[type=tel]:visible, textarea:visible, select:visible").removeClass("error"),isset(a.errors)&&$.each(a.errors,function(a,c){var d=/[a-z]/i;if(d.test(a)){var e=$(b.form).find("[name="+a+"]");1==e.length&&$(e).addClass("error")}}))),$(c).prop("disabled",!1),$(c).removeClass("is-loading"),isset(a.ok)&&1==a.ok&&($(b.form)[0].reset(),$(".b-form").addClass("bounceOut"),setTimeout(function(){$(".message-send-ok").addClass("is-visible bounceIn")},300),setTimeout(function(){$(".b-form").removeClass("bounceOut"),$(".message-send-ok").removeClass("is-visible bounceIn")},2500))}})}$(document).ready(function(){!function(){var b=$(".e-btn_feedback");b.length>0&&b.each(function(){var b=$(this).closest("form"),c=b.attr("name");isset(a[c])&&isset(a[c].cfg.antispamjs)&&$(b).prepend('<input type="text" name="'+a[c].cfg.antispamjs+'" value="tesby" style="display:none;">')})}()}),$(document).on("mouseenter mouseover",".e-btn_feedback",function(){var b=$(this).closest("form"),c=b.attr("name");isset(a[c])&&isset(a[c].cfg.antispamjs)&&$("input[name="+a[c].cfg.antispamjs+"], textarea[name="+a[c].cfg.antispamjs+"]").val("")}),$(document).on("click",".e-btn_feedback",function(){var a=$(this).closest("form"),c=a.attr("name"),d={};return d.form=a,d.act=c,d.data=$(a).serialize(),b(d),!1})});var RH={};RH.is_mobile=new window.MobileDetect(window.navigator.userAgent),RH.event_type="",RH.is_mobile.mobile()?RH.event_type="touchend":RH.event_type="click",$(document).ready(function(){var a=new window.keypress.Listener;a.simple_combo("alt a s",function(){$("body").addClass("is-developer-name")})}),$(document).ready(function(){$("body").imagesLoaded(function(){setTimeout(function(){$("body").removeClass("is-loading").addClass("is-loaded")},800)}),$("[data-to-id]").on("click",function(){var a=$(this).data("to-id");$("html, body").animate({scrollTop:$("#"+a).offset().top-30},1e3)}),$(".b-section_funs-items").slick({infinite:!0,slidesToShow:3,slidesToScroll:3,prevArrow:'<div class="slick-prev"><i class="ico_arrow-left-grey"></i></div>',nextArrow:'<div class="slick-next"><i class="ico_arrow-right-grey"></i></div>',mobileFirst:!0,responsive:[{breakpoint:1200,settings:{slidesToShow:4,slidesToScroll:4}}]}),$(".b-section_catalog-img").slick({infinite:!0,slidesToShow:1,slidesToScroll:1,prevArrow:'<div class="slick-prev"><i class="ico_arrow-left-white"></i></div>',nextArrow:'<div class="slick-next"><i class="ico_arrow-right-white"></i></div>',asNavFor:".b-section_catalog-content",focusOnSelect:!0}),$(".b-section_catalog-content").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,asNavFor:".b-section_catalog-img"}),RH.is_mobile.mobile()||$.stellar({horizontalScrolling:!1,verticalOffset:40,responsive:!0})});